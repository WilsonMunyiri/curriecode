...
import com.example.kojpy.databinding.ActivitySciencetopicsgrade3Binding

private lateinit var binding: ActivitySciencetopicsgrade3Binding
class sciencetopicsgrade3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivitySciencetopicsgrade3Binding.inflate(layoutInflater)
