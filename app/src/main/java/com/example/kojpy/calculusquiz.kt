...
private lateinit var binding: ActivityCalculusquizBinding

class calculusquiz : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCalculusquizBinding.inflate(layoutInflater)
